...
<body>
    ...
    <div class="text-center" style="margin-left: 40%; margin-right: 40%;">
        <form action="chkInsert.php" method="POST">
            ...
            <div class="form-group">
                <label for="txtQuantita">Quantitá</label>
                <input required='true' type="number" class="form-control" id="txtQuantita" placeholder="Inserisci la quantitá di prodotti" name="txtQuantita">
            </div>
            <br>
